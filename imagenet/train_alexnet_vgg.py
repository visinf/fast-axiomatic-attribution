# obtained from https://github.com/pytorch/examples/tree/master/imagenet
...
from models import AlexNet, XAlexNet, vgg16, xvgg16

model_names = ['alexnet', 'xalexnet', 'vgg16', 'xvgg16']
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.arch == 'alexnet':
        model = AlexNet()
    elif args.arch == 'xalexnet':
        model = XAlexNet()
    elif args.arch == 'vgg16':
        model = vgg16()
    elif args.arch == 'xvgg16':
        model = xvgg16()
